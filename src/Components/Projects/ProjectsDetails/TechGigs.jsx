...
const TechGigs = () => {
    return (
         <motion.div
            className="card bg-[#DED3C4] shadow-6xl max-w-5xl mx-auto my-10 rounded-3xl border border-gray-200"
            ...
            <div className="card-body space-y-6 text-[#2C1250]">
                <section>
                    ...
                    <p className="text-2xl font-medium">
                        Built with MERN stack, TechGigs is a full-stack project that helps users to pick tasks according to their choices!                    </p>
                </section>
